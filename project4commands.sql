...
# Command 3D: add a new record to shipments table (S39, P3, J1, 20)
insert into shipments
values ('S39','P3','J1', 20);
...
# Command 5C: Update the shipments table by increasing the quantity by 10 every
#             shipment of part P3.
update shipments
